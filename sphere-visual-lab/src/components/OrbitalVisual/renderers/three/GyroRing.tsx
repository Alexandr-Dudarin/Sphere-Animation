...
export default function GyroRing({
  ...
  useFrame((state) => {
    ...
    /*
     * Пространственное движение задаётся
     * явно в пресете и не смешивается
     * с внутренним вращением сегментов.
     */
    if (
      ...
      /*
       * Кольцо сохраняет свой наклон и
       * целиком вращается в экранной
       * плоскости вокруг центрального ядра.
       */
      ...
      /*
       * Горизонтальное reveal-кольцо:
       * вращение идёт вокруг оси X,
       * поэтому кольцо циклически видно
       * то почти ребром, то широким
       * горизонтальным овалом.
       */
      precessionRef.current.rotation.set(
        0,
        0,
      ...
      /*
       * Вертикальное reveal-кольцо:
       * вращение идёт вокруг оси Y,
       * поэтому кольцо циклически видно
       * то ребром, то широкой вертикальной
       * овальной частью.
       */
      precessionRef.current.rotation.set(
        0,
